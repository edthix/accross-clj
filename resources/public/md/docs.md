<div class="bs-callout bs-callout-danger">
 ...
 <ol>
   ...
   <li> Update the connection parameters for the database in the <code>accross-clj.db.schema</code> namespace of your application.
...
Request middleware functions are located under the `accross-clj.middleware` namespace.
